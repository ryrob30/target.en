...
A possible reason for the model not being better than radom might be that the offers are not significantly different from each other. If this is the case, you can try increasing the differences in the offers by making them more visually different or by changing the content itself.
